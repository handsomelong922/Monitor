const zhCN = {
  translation: {
    ...
    "monitor.body": "请求体",
    "monitor.timezone": "时区",
    "monitor.activeWindows": "活跃时间窗口",
    "monitor.activeDays": "活跃天数",
    "monitor.noActiveWindows": "全天监控",
    "monitor.noActiveDays": "每天",
    ...
    // 监控时间窗口配置
    "monitor.form.schedule": "监控调度",
    "monitor.form.scheduleHelp": "配置监控的活跃时间窗口和天数",
    "monitor.form.timezone": "时区",
    "monitor.form.timezonePlaceholder": "选择时区",
    "monitor.form.timezoneHelp": "监控将在此时区中评估时间窗口",
    "monitor.form.activeWindows": "活跃时间窗口",
    "monitor.form.activeWindowsHelp": "指定每天监控的活跃时间段，留空表示全天监控",
    "monitor.form.addTimeWindow": "添加时间窗口",
    "monitor.form.startTime": "开始时间",
    "monitor.form.endTime": "结束时间",
    "monitor.form.removeTimeWindow": "删除时间窗口",
    "monitor.form.activeDays": "活跃天数",
    "monitor.form.activeDaysHelp": "选择监控在一周中的哪些天活跃",
    "monitor.form.dayPreset": "日期预设",
    "monitor.form.everyday": "每天",
    "monitor.form.workdays": "工作日",
    "monitor.form.weekends": "周末",
    "monitor.form.custom": "自定义",
    "monitor.form.sunday": "周日",
    "monitor.form.monday": "周一",
    "monitor.form.tuesday": "周二",
    "monitor.form.wednesday": "周三",
    "monitor.form.thursday": "周四",
    "monitor.form.friday": "周五",
    "monitor.form.saturday": "周六",
